                        ...
                        <ThemeProvider theme={{ palette }}>
                            <Routes>
                                ...
                                <Route path="/writing" element={<Writing />}>
                                    ...
                                    <Route
                                        path="step1/diary-contents-view"
                                        element={<DiaryContentsViewStep1 />}
                                    />
                                    <Route
                                        path="step2/diary-contents-view"
                                        element={<DiaryContentsViewStep2 />}
                                    />
                                ...
                                <Route
                                    path="diary/2"
                                    element={<DiaryDetail2 />}
                                />
                                <Route
                                    path="diary/3"
                                    element={<DiaryDetail3 />}
                                />
                                <Route
                                    path="diary/4"
                                    element={<DiaryDetail4 />}
                                />
                                <Route
                                    path="diary/5"
                                    element={<DiaryDetail5 />}
                                />
                                <Route path="*" element={<NotFound />} />
                            </Routes>
                        </ThemeProvider>
