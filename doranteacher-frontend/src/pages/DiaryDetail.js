...
function DiaryDetail() {
	...
	const diaryDetail = () => {
		axios
			.get(`https://api.doranssam.com/diaries/${id}`, {
				headers: {
										...
										<div>
											...
											{data.correct_text &&
												data.correct_text.map((text) =>
													text[0] === '#' ? (
														<span className="answer_green">{text.slice(1)}</span>
													) : (
					...
					<div className="rightside">
						...
						<div className="photo-wrapper">
							...
							<div className="photo-box">
								<img className="diary_img" src={data.selectedImage} height="240" width="380" alt="" />
							</div>
						</div>
					</div>
				</div>
