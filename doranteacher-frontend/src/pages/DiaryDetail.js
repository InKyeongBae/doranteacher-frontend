					...
					<div className="leftside">
						<div className="mini-header-wrapper">
							...
							<ImgButton
								...
								outputColor="red"
								extraClassName={correct === true ? `correct_button on` : 'correct_button'}
							></ImgButton>
						</div>
					...
					<div className="rightside">
						<div className="comment-wrapper">
							<div className="comment-title-wrapper">
								<img src={doran_img} height="140" width="95"></img>
						...
						<div className="photo-wrapper">
							...
							<img className="diary_img" src={diary_img} height="350" width="350" alt="" />
						</div>
					</div>
				</div>
			</MainBlock>
