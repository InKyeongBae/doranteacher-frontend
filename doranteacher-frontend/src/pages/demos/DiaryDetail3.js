...
const dummyData =
	// 서버로부터 데이터를 받아와야함
	{
		...
		date: '2022년 05월 08일',
		diaryType: '효도일기',
		keywords: ['#빨래', '#수박', '#어버이날', '#연어초밥', '#엄마', '#양말'],
									...
									<div className="answers">
										...
										{!correct ? (
											...
											<div className="answer">
												...
												어버이날이라 집안일을 도와<span className="mama">드려따</span>. 엄마가
												고맙다고 하셨다. 효도를 하니 감사한 마음이{' '}
												<span className="mama">드러따</span>. 엄마가 평소에도 도와주었으면
												좋겠다고 하셨다. 앞으로도 자주 집안일을 도와드려야겠다.
											</div>
										)}
									</div>
