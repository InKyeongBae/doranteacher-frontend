									...
									<div className="answers">
										...
										{!correct ? (
											...
											만점이다. */}
												...
												<span className="mama">김치보끔밥</span>을 만들었다. 친구한테 같이 밥
												먹자고 전화했는데 집에 와서 요리하자고 했다. 김치랑 밥이랑 스팸을{' '}
												<span className="mama">너었따.</span>. 계란후라이도 올렸다. 만들기는
												정말 쉬웠는데 정말 정말 맛있었다! 내일은 내가 잘하는 짜파게티를 해주기로
												했다. 맛있겠다!
											</div>
										)}
									</div>
