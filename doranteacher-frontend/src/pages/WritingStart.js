	...
	return (
		<>
			...
			<Header
				...
				isLogout
				isImgBtn
				progress={<Progressbar progressText={'1.일기 시작'} progressRate={15} progressColor={'#E75244'}></Progressbar>}
			/>
			<MainBlock>
				...
				<StyledLink to="/first-step">
					<div className="nextButton">
						<Button buttonText="다음" type="submit" outputColor="red" className="button"></Button>
					</div>
				</StyledLink>
			</MainBlock>
		</>
