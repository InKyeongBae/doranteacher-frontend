					...
					<SignupUI>
						<form onSubmit={onSubmitHandler}>
							<div className="signupform">
								...
								<div className="column">
									<label className="content">비밀번호 확인</label>
									<Input className="input" type="password" value={ConfirmPassword} onChange={onConfirmPasswordHandler} />
								</div>

								<br />
								<Button buttonText="회원가입" type="submit" outputColor="red" className="content_button"></Button>
							</div>
						</form>
					</SignupUI>
				</div>
