		...
		<>
			...
			<SettingUI>
				<div className="step_buttons">
					<Button buttonText="1단계" outputColor="green" className="step_button"></Button>

					<Button buttonText="2단계" outputColor="green" className="step_button"></Button>
				</div>
			...
			<SaveUI>
				<div className="saveButton">
					<Button buttonText="저장하기" type="submit" outputColor="red" className="button"></Button>
				</div>
			</SaveUI>
		</>
	);
